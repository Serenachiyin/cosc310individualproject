...
public class Dict{
    ...
    public Dict() throws JWNLException, FileNotFoundException, InterruptedException{        
        ...
        String rr = System.getProperty("user.dir") + "/ChatbotProject/Dictionaries/dict/";
        System.out.println("Filepart: " + rr);
    ...
    private boolean isConjunction(String word){
        try {
            this.conjunctionFilePath = new FileInputStream(System.getProperty("user.dir") + "/ChatbotProject/Dictionaries/additionalDict/conjunctions.txt");
    ...
    private boolean isHFVerb(String word){
        try {
            this.highFreqVerbFilePath = new FileInputStream(System.getProperty("user.dir") + "/ChatbotProject/Dictionaries/additionalDict/highFrequentVerb.txt");
        } catch (FileNotFoundException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        } 
    ...
    private boolean isPronoun(String word){
        try {
            this.pronounFilePath = new FileInputStream(System.getProperty("user.dir") + "/ChatbotProject/Dictionaries/additionalDict/pronouns.txt");
        } catch (FileNotFoundException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        } 
    ...
    private String checkInAddDict(String word) throws FileNotFoundException{
        try {
            this.highFreqWordFilePath = new FileInputStream(System.getProperty("user.dir") + "/ChatbotProject/Dictionaries/additionalDict/highFrequentWords.txt");
        } catch (FileNotFoundException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        } 
